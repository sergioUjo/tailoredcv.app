...
function PrivacyPolicy() {
    return (
        <div className={"bg-white"}>
            <Header/>
            <div className={"m-auto max-w-7xl justify-between px-4 flex flex-col gap-1 py-4"}>

                <h1 className={"text-2xl font-bold py-4"}>Privacy Policy for TailoredCV</h1>

                <p>At TailoredCV, accessible from https://www.tailoredcv.app/, one of our main priorities is the privacy
                    of our visitors. This Privacy Policy document contains types of information that is collected and
                    recorded by TailoredCV and how we use it.</p>

                <p>If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>

                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in TailoredCV. This policy is not
                    applicable to any information collected offline or via channels other than this website.</p>

                <h2 className={"text-lg pt-4 pb-1 font-bold"}>Consent</h2>

                <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

                <h2 className={"text-lg pt-4 pb-1 font-bold"}>Information we collect</h2>
                ...
                <h2 className={"text-lg pt-4 pb-1 font-bold"}>How we use your information</h2>
                ...
                <h2 className={"text-lg pt-4 pb-1 font-bold"}>Log Files</h2>

                <p>TailoredCV follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <h2 className={"text-lg pt-4 pb-1 font-bold"}>Advertising Partners Privacy Policies</h2>
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on TailoredCV, which are sent
                ...
                <p>Note that TailoredCV has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h2 className={"text-lg pt-4 pb-1 font-bold"}>Third Party Privacy Policies</h2>

                <p>TailoredCV's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                ...
                <h2 className={"text-lg pt-4 pb-1 font-bold"}>CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                ...
                <h2 className={"text-lg pt-4 pb-1 font-bold"}>GDPR Data Protection Rights</h2>
                ...
                <h2 className={"text-lg pt-4 pb-1 font-bold"}>Children's Information</h2>
                ...
                <p>TailoredCV does not knowingly collect any Personal Identifiable Information from children under the
                ...
                <h2 className={"text-lg pt-4 pb-1 font-bold"}>Changes to This Privacy Policy</h2>
                ...
                <h2 className={"text-lg pt-4 pb-1 font-bold"}>Contact Us</h2>
